...
class NsDiffForecast(ProbForecastExp, NsDiffParameters):
    ...
    def _init_model(self):
        # build model and conditional predictors
        ...
        # load pretrained F and G if requested
        if self.load_pretrain:
            identifier = self._run_identifier(self.seed)
    ...
    def _setup_run(self, seed):
        # store seed for loading corresponding pretrain runs
        self.seed = seed
        # call base setup to initialize experiment
        super()._setup_run(seed)
